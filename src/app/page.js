...
`}
          <span className="ascii-subtitle">
            <TypingAnimation words={["Reverse Engineer", "Wanna be Offensive ICS/OT Expert", "Wanna be Smart Contract Auditor"]} />
          </span>
        </pre>
      </div>
      ...
      >
        <a
          href="https://github.com/recreat0rz"
          target="_blank"
        ...
        <a
          href="https://discord.com/users/426490670438678530"
          target="_blank"
          rel="noopener noreferrer"
          style={{ color: "var(--text-secondary)", transition: "color 0.2s" }}
        >
        ...
        <a
          href="https://medium.com/@recreat0rz"
          target="_blank"
          rel="noopener noreferrer"
          style={{ color: "var(--text-secondary)", transition: "color 0.2s" }}
        >
